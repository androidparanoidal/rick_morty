...
import 'package:rick_morty/features/data/datasources/person_local_data_source.dart';
import 'package:rick_morty/features/data/datasources/person_remote_data_source.dart';
import 'package:rick_morty/features/data/models/person_model.dart';
...
class PersonRepositoryImpl implements PersonRepository {
  ...
  Future<Either<Failure, List<PersonModel>>> _getPersons(
    ...
    if (await networkInfo.isConnected) {
      ...
      try {
        // if user is not connected to network
